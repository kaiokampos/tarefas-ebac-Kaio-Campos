package com.kaio.interfaces.dao;

import com.kaio.exceptions.DAOException;
import com.kaio.exceptions.MaisDeUmRegistroException;
import com.kaio.exceptions.TableException;
...
public interface IGenericDAO <T extends Persistente, E extends Serializable> {
    ...
    /**
     * Método buscarTodos que irá retornar todos os registros do banco de dados de uma determinado dado ou tabela
     *
